...
type Installer struct {
	...
	StandardRate         *int64    `json:"standard_rate" db:"standard_rate"` // paise
...
type Installation struct {
	...
	AgreedInstallerPrice    *int64     `json:"agreed_installer_price" db:"agreed_installer_price"` // paise
	...
	InstallerAdvanceAmount  int64      `json:"installer_advance_amount" db:"installer_advance_amount"` // paise
	InstallerFinalAmount    int64      `json:"installer_final_amount" db:"installer_final_amount"`     // paise
